    ...
    <div className="kp-page kp-rtl">
      <div className="inner">
        ...
        <div className="about-grid">
          <div>
            <p style={{marginBottom:'12px'}}>אנו מומחים בתחום סגירת מרפסות מודרנית. אנו מייצגים יצרנים הפועלים בשוק הישראלי למעלה מ-7 שנים עם מחזור ייצור מלא.</p>
            <p style={{marginBottom:'12px'}}>כל הייצור מתבצע במפעל אותו תוכלו לבקר בכל עת ולהשתכנע שעבודות ההזמנה שלכם מבוצעות בזמן.</p>
            <p>הייצור שלנו מבטיח איכות גבוהה, מהירות ואמינות.</p>
          </div>
